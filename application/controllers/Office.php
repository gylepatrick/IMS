...
class Office extends BaseController {
    ...
    public function index() {
        ...
        $data['offices'] = $this->Office_model->get_all_office();
        ...
        $data['title'] = "IMS | OFFICE SUPPLIES";
    ...
    public function get_item_by_barcode() {
        ...
        $items = $this->Office_model->get_item_by_barcode($barcode);
    ...
    public function get_low_stock_items() {
        ...
        $query = $this->db->get('inv_office'); // Change 'inv_office' to your actual inventory table
    ...
    public function delete_issuance() {
        ...
        $issuance = $this->db->get_where('inv_office', ['id' => $id])->row();
        ...
        if ($type == 'Purchase' || $type == 'Donation') {
            ...
            $this->db->update('inv_office');
    
            // 🔹 Delete only the specific issuance record
            $this->db->delete('inv_office', ['id' => $id]);
        }
    ...
    public function save_transaction() {
        $this->load->model('Office_model'); // Load model
        ...
        $current_balance = $this->Office_model->get_balance_by_barcode($barcode);
        ...
        if ($type === 'Issuance' || $type === 'Disposal') {
            ...
            $this->Office_model->update_balance($barcode, $new_balance);
        }
        ...
        // Save transaction
        $insert = $this->Office_model->save_transaction($data);
    ...
    public function update_transaction() {
        ...
        if ($type == 'Issuance' || $type == 'Disposal') {
            ...
            $this->db->update('inv_office', ['balance' => $new_previous_balance]);
    ...
    public function add_office() {
        ...
        if ($this->Office_model->insert_office($data)) {
