...
class PPE extends BaseController {
    ...
    public function index() {
        ...
        $this->load->model('Medicine_model');
        $data['ppes'] = $this->PPE_model->get_all_ppe();
        ...
        $this->load->view('ppe/index', $data);
        $this->load->view('templates/ppe_modal');
    ...
    public function store() {
       // Get form inputs
        ...
        $this->PPE_model->insert_ppe($data);
    ...
    public function get_item_by_barcode() {
        ...
        $items = $this->PPE_model->get_item_by_barcode($barcode);
    ...
    public function get_low_stock_items() {
        ...
        $query = $this->db->get('inv_ppe'); // Change 'inv_ppe' to your actual inventory table
    ...
    public function delete_issuance() {
        ...
        $issuance = $this->db->get_where('inv_ppe', ['id' => $id])->row();
        ...
        if ($type == 'Purchase' || $type == 'Donation') {
            ...
            $this->db->update('inv_ppe');
    
            // 🔹 Delete only the specific issuance record
            $this->db->delete('inv_ppe', ['id' => $id]);
        }
    ...
    public function save_transaction() {
        $this->load->model('PPE_model'); // Load model
        ...
        $current_balance = $this->PPE_model->get_balance_by_barcode($barcode);
        ...
        if ($type === 'Issuance' || $type === 'Disposal') {
            ...
            $this->PPE_model->update_balance($barcode, $new_balance);
        }
        ...
        // Save transaction
        $insert = $this->PPE_model->save_transaction($data);
    ...
    public function update_transaction() {
        ...
        if ($type == 'Issuance' || $type == 'Disposal') {
            ...
            $this->db->update('inv_ppe', ['balance' => $new_previous_balance]);
    ...
    public function add_office() {
        ...
        if ($this->PPE_model->insert_office($data)) {
