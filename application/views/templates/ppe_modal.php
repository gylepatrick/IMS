    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="addBookModalLabel">ACQUISITION/PURCHASE/ISSUANCE/DISPOSAL REPORT</h6>
...
<!-- Add Modal -->
<div class="modal modal  radius fade" id="addItem" tabindex="-1" aria-labelledby="addItemLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="addItemLabel"><i class="fas fa-hard-hat"></i> NEW SUPPLY</h5>
                <button type="button" class="btn-close bg-white text-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('ppe/store'); ?>" method="POST">
                    ...
                    ** Provide N/A if the field/s is "NOT APPLICABLE" **    
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label"><i class="fas fa-calendar-alt"></i> Entered Date</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label"><i class="fas fa-tag"></i> Item Code</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label"><i class="fas fa-location"></i> Location</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label"><i class="fas fa-boxes"></i> Unit Type (Ex. pc, box)</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= htmlspecialchars($this->session->userdata('full_name')); ?>" name="entered_by" readonly>
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label"><i class="fas fa-users"></i> <small>Requesting Office/Person</small></label>
...
<script>
       ...
       $("#barcodeInput1").keypress(function (event) {
           if (event.which === 13) { // Enter key
               ...
               if (barcode !== "") {
                   $.ajax({
                       type: "POST",
                       url: "<?= base_url('ppe/get_item_by_barcode') ?>",
   ...
   function saveTransaction() {
       ...
       $.ajax({
           type: "POST",
           url: "<?= base_url('ppe/save_transaction') ?>",
           data: data,
           dataType: "json",
           success: function (response) {
               if (response.status === "success") {
...
<script>
   ...
   $("#updateForm").on("submit", function (event) {
       ...
       $.ajax({
           type: "POST",
           url: "<?= base_url('ppe/update_transaction') ?>",
           data: $(this).serialize(),
           dataType: "json",
           success: function (response) {
               if (response.status === "success") {
...
$(document).on('click', '.deleteBtn', function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '<?= base_url("ppe/delete_issuance") ?>',
                type: 'POST',
                data: {
                    id: id,
                    type: type,
