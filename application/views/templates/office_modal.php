<!-- Add Modal -->
<div class="modal radius fade" id="addOffice" tabindex="-1" aria-labelledby="addItemLabel" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
         <div class="modal-header bg-primary text-white">
            <h5 class="modal-title" id="addItemLabel"><i class="fas fa-plus-circle"></i> ADD OFFICE SUPPLY</h5>
            <button type="button" class="btn-close bg-white text-white" data-bs-dismiss="modal" aria-label="Close"></button>
         </div>
         <div class="modal-body">
            <form action="<?= base_url('office/store'); ?>" method="POST">
            <div class="alert alert-sm alert-warning" id="alert-warning" role="alert">
               ...
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <div class="mb-3">
                        <label class="form-label"><i class="fas fa-file-alt"></i> Requesting Office</label>
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="mb-3">
                        <label class="form-label"><i class="fas fa-file-alt"></i> Location</label>
...
<!-- Release Modal -->
<div class="modal fade" id="releaseOffice" tabindex="-1" aria-labelledby="releaseItemLabel" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
         <div class="modal-header bg-primary text-white">
...
<script>
   $(document).ready(function () {
       $("#barcodeInput1").keypress(function (event) {
           if (event.which === 13) {
               ...
               if (barcode !== "") {
                   $.ajax({
                       type: "POST",
                       url: "<?= base_url('office/get_item_by_barcode') ?>",
    ...
    <div class="text-center mt-3">
        <button class="btn btn-primary shadow-lg" id="saveButton" disabled>Save Transaction</button>
    </div>
   </div>
   ...
   function saveTransaction() {
       ...
       $.ajax({
           type: "POST",
           url: "<?= base_url('office/save_transaction') ?>",
           data: data,
           dataType: "json",
           success: function (response) {
               if (response.status === "success") {
...
// Function to enable/disable Unit Cost field based on Transaction Type
...
$(".updateBtn").on("click", function () {
    ...
    $("#updateBarcode").val($(this).data("barcode"));
...
// Re-check Unit Cost readonly rule when transaction type changes
$("#updateType").on("change", checkTransactionType);

// Auto-calculate Total Cost = Quantity * Unit Cost
...
$("#updateForm").on("submit", function (event) {
    ...
    $.ajax({
        type: "POST",
        url: "<?= base_url('office/update_transaction') ?>",
        data: $(this).serialize(),
        dataType: "json",
        success: function (response) {
            Swal.fire({
...
$(document).on('click', '.deleteBtn', function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '<?= base_url("office/delete_issuance") ?>',
                type: 'POST',
                data: {
                    id: id,
                    type: type,
