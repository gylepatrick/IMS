<div class="col-12">
      ...
      <h4><i class="fa-solid fa-screwdriver-wrench"></i>
      Property and Equipments</h4>
      <div class="btn-group">
               ...
               <table id="example" class="table table-bordered ">
                  <thead class="bg-primary text-white">
                     <tr>
                        ...
                        <th><i class="fa-solid fa-user-tie"></i> Requesting Office/Person</th>
                        <th><i class="fa-solid fa-location-dot"></i> Location</th>
                        <th><i class="fa-solid fa-cube"></i> Unit</th>
